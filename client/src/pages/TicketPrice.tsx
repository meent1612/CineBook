export default function TicketPrice() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0f0f0f", fontFamily: "'Georgia', serif" }}>
      ...
      <div
        style={{
          background: "linear-gradient(160deg, #1a0008 0%, #6B1829 50%, #1a0008 100%)",
      ...
      >
        ...
        <div style={{
          ...
          background: "repeating-linear-gradient(90deg, #000 0px, #000 18px, #1a0008 18px, #1a0008 36px)",
          display: "flex", alignItems: "center",
        }}>
          {Array.from({ length: 40 }).map((_, i) => (
            <div key={i} style={{ width: "18px", height: "10px", background: "#000", border: "2px solid #222", flexShrink: 0, marginRight: "18px", borderRadius: "2px" }} />
          ))}
        </div>

        <div style={{
          position: "absolute", inset: 0,
          backgroundImage: "radial-gradient(circle at 20% 50%, rgba(255,255,255,0.03) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(255,200,100,0.04) 0%, transparent 50%)",
        }} />
        ...
        <div style={{
          ...
          background: "repeating-linear-gradient(90deg, #000 0px, #000 18px, #0f0f0f 18px, #0f0f0f 36px)",
        }} />
      </div>
        ...
        {prices.map(p => (
          ...
          >
            ...
            <div style={{ padding: "1.75rem 1.5rem" }}>
              ...
              <div style={{
                fontSize: "0.68rem",
                color: p.highlight ? "rgba(255,255,255,0.7)" : "#888",
                letterSpacing: "0.2em",
                textTransform: "uppercase",
                marginBottom: "0.3rem",
              }}>
              ...
              <div style={{
                ...
                fontSize: "2.4rem",
                fontWeight: 800,
                color: p.highlight ? "#f5c842" : "white",
                lineHeight: 1,
                marginBottom: "0.2rem",
              }}>
              ...
              <div style={{
                height: "1px",
                background: p.highlight ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.08)",
                marginBottom: "1rem",
              }} />
              ...
              <p style={{
                fontSize: "0.76rem",
                color: p.highlight ? "rgba(255,255,255,0.8)" : "#999",
                lineHeight: 1.65,
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem", marginBottom: "1.5rem" }}>
                {p.features.map(f => (
                  <div key={f} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <span style={{ color: p.highlight ? "#f5c842" : "#6B1829", fontSize: "0.75rem" }}>✓</span>
