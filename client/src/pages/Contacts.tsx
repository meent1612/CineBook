...
export default function Contacts() {
  ...
  const contactInfo = [
    { icon: "📍", label: "Address", value: "Love Road, Tejgaon, Dhaka 1215, Bangladesh" },
    { icon: "📞", label: "Phone", value: "+880 1700-000000" },
    { icon: "📧", label: "Email", value: "support@cinebook.com.bd" },
    { icon: "🕐", label: "Booking Hours", value: "9:00 AM – 11:00 PM (Daily)" },
  ];
    ...
    <div style={{ minHeight: "100vh", background: "#f0f0f0" }}>
      ...
      >
        ...
        <div style={{ width: "280px", flexShrink: 0 }}>
          ...
          >
            ...
            {contactInfo.map(item => (
              <div key={item.label} style={{ display: "flex", gap: "0.75rem", marginBottom: "1.1rem" }}>
                <div style={{ fontSize: "1.3rem", marginTop: "1px" }}>{item.icon}</div>
                <div>
                  <div style={{ fontSize: "0.7rem", color: "#999", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "0.15rem" }}>
                    {item.label}
                  </div>
          ...
          >
            <div style={{ fontSize: "0.75rem", color: "#999", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "0.85rem" }}>
              Follow Us
            </div>
